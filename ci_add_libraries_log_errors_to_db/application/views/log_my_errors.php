...
?>
<code>
<p><b>Error Type:</b> <?php echo "#".$err['id']." ".$err['errtype']; ?></p>
<p><b>Error Number:</b> <?php echo $err['errno']; ?></p>
<p><b>Error Is:</b> <?php echo $err['errstr']; ?></p>
<p><b>File Name:</b> <?php echo $err['errfile']; ?></p>
<p><b>Line Number:</b> <?php echo $err['errline']; ?></p>
<p><b>User Browser:</b> <?php echo $err['user_agent']; ?></p>
<p><b>User IP:</b> <?php echo $err['ip_address']; ?></p>
<p><b>Loged On:</b> <?php echo $err['time']; ?></p>
</code>
<?php }} else { ?>
<p>There is no errors found, in this Web App</p>
<?php } ?>
</div>
